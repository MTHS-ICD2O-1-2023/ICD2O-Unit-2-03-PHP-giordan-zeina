...
<html>
  <head>
    ...
    <title>Address webpage made with Javascript</title>
  </head>
  <body>
        ...
        <!-- Simple Textfield -->
          <form action="answer.php" method="POST">
            ...
            <div class="mdl-textfield mdl-js-textfield">
              ...
              <label class="mdl-textfield__label" for="name-input">Street number</label>
            </div>
            <br />
            <p>Street Name</p>
            <div class="mdl-textfield mdl-js-textfield">
              <input class="mdl-textfield__input" type=" text" name="street-name">
              <label class="mdl-textfield__label" for="age-input">Street name</label>
